    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="text-gray-400">
                    ...
                    <p class="mt-12">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Id, obcaecati. Facere sed nulla ea quisquam iusto, voluptatibus nisi est laborum quia ab minus quam nostrum. Explicabo adipisci labore magnam sed.</p>
                    <div class="mt-12">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="">
                        <img src="images/wall1.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="">
        ...
        <div class="similar-games-container mt-8">
            ...
            <div class="popular-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12 pb-3">
                {{-- INICIO JOGO --}}
                <div class="game mt-8">
